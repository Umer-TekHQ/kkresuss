...
import { View, Image, StyleSheet, Dimensions ,DimensionValue,Text,TouchableOpacity} from 'react-native'
...
const Background = ({ showContent = true,children ,showLogo,hideBottomImages,containerHeight, containerStyle,showLostAccess  }: Props) => {
  return (
    <LinearGradient
...
{showLostAccess && (
      <TouchableOpacity style={BackgroundStyles.lostAccessContainer}>
        <Text style={BackgroundStyles.lostAccessText}>Lost access to email or phone?</Text>
      </TouchableOpacity>
    )}
